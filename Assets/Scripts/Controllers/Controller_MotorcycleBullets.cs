...
{
    public class Controller_MotorcycleBullets : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            values = gameModel.GetComponent<MotorcycleEnemy>();
        ...
        void Update()
        {
            for (int i = _bulletsActive.Count - 1; i >= 0; i--)
            {
                ...
                tracker.bullet.transform.position += tracker.direction * Time.deltaTime * values.bulletSpeed;
